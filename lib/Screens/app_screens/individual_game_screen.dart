...
class IndividualGameScreen extends StatelessWidget {
  const IndividualGameScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        commonContainer(AppStrings.joinPrivate, context)
      ],
    );
  }

  Widget commonContainer(String text, BuildContext context) {
    return Padding(
